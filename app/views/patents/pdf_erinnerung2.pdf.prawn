...
pdf.bounding_box [300,614], :width => 230 do
    pdf.font ("Times-Roman",:size=>12) do
      pdf.draw_text  ("Letzte Erinnerung!",:style=>:bold, :at=>[(pdf.bounds.left+10),pdf.bounds.left-15])
 ...
 pdf.text_box  "Letzte Überwachungserinnerung für ihre Patentanmeldung " +@patent.amtlaktenzeichen+" 
